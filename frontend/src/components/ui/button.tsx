...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary-hover shadow-ocean",
        destructive:
        ...
        hero: "gradient-hero text-white hover:scale-105 shadow-ocean text-lg font-semibold",
        wave: "bg-accent/20 text-primary border border-accent hover:bg-accent/30 hover:shadow-wave",
        alert: "bg-warning text-warning-foreground hover:bg-warning/90 shadow-alert pulse-glow",
